...
### Changed
- Config stub and README now link the CKEditor references for editor options, toolbar item names and per-plugin feature docs, and document the upgrade path for configs published before 2.1.0.
